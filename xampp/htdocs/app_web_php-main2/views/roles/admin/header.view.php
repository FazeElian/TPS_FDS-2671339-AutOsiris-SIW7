...
<!--Imagen Logo Empresa-->
<div class="img_logo">
    <a href="index.php"> <img src="assets/img/Logo S.I. AutOsiris.png"> </a>
</div>
...
<div class="menu_sup">
    ...
    <div class="menu_nav">
        ...
        <div class="nav1">
            <li>
                <a href="?"> <h1> Inicio </h1> </a>
                <a href="views/modules/7_statistics/index-estadisticas.php"> <h1> Estadísticas </h1> </a>
                <a href="views/modules/4_sales/index-ventas.php"> <h1> Ventas </h1> </a>
                <a href="views/modules/2_products/index-productos.php"> <h1> Productos </h1> </a>
            </li>
        </div>

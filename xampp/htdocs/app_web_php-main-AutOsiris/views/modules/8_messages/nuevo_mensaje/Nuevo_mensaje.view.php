...
<div class="contenido_pag">
    ...
    <!-- Contenedor Apartado Destinatario -->
    <div class="cont_destinatario">
        <h2> Agregar destinatario: Distribuidor Osiris </h2>
    </div>

    <!-- Contenido Apartado de Escritura - Escribe aquí... -->
    <div class="cont-escribe_aquí">
        <input type="text" placeholder= "Escribe aquí">
    </div>

    <!-- Apartado Agregar Producto -->
    <div class="agregar_producto">
        <!-- Botón Texto -->
        <div class="bott_texto">
            <a href="#"> <h3> Agregar Producto </h3></a>
        </div>

        <!-- Botón Icono - Imagen -->
        <div class="bott_icono">
            <a href="#"> 
                <img src="assets/img/Icono_añadir.png">
            </a>
        </div>
    </div>

    <!-- Botón Cancelar -->
    <div class="bott_cancelar">
        <a href="index.html"> <h3> Cancelar </h3> </a>
    </div>

    <!-- Botón Enviar -->
    <div class="bott_enviar">

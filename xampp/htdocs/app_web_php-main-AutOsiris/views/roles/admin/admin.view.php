...
<header class="menu_sup">
	<div class="nav_menu">
		<a href="?"><li class="inicio"> Inicio </li></a>
		<a href="?c=nuestros_productos"><li class="nuestros_prod"> Nuestros Productos </li>
		<a href="?c=nosotros"><li class="menu_items"> Nosotros </li>
		<a href="?c=contactanos"><li class="menu_items"> Contáctanos </li>
	</div>

	<div class="login_menu">
		<a href="?c=Login"><li class="iniciar_sesion"> Iniciar sesión </li></a>
		<a href="?c=Signup"><li class="registrarse"> Registrarse </li></a>
	</div>
</header>

<!-- Banner Principal -->
<section class="banner">
	<a href="#"><img src="https://img.freepik.com/vector-premium/diseno-banner-web-negocios-moderno-vector-premium_153792-152.jpg?w=2000"></a>
</section>

<!-- Lineas de separación de contenido -->
...
<section class="nav_tienda">
    ...
    <div id="calend"> 
        ...
        <!-- Días -->
        <table id="dias"> 
            <td class="dias">Dom</td> 
            <td class="dias">Lun</td> 
            <td class="dias">Mar</td> 
            <td class="dias">Mié</td> 
            <td class="dias">Jue</td> 
            <td class="dias">Vie</td> 
            <td class="dias">Sáb</td>
        </table> 
        ...
        <div id="cal-frame"> 
            <table class="curr"> 
            <tbody> 
                <tr><td class="nil"></td><td class="nil"></td><td>1</td><td>2</td><td>3</td><td>4</td><td class="today">5</td></tr> 
    ...
    <!-- Anuncio de descuentos segun calendario -->
    <div class="ad_desc">
        <p> Actualmente tenemos muchos descuentos en cada categoría! </p>
        <p>Desde bonos por ser primer usuario hasta acceso a beneficios 
        por ser comprador contante. Aquí te recompensamos tu compra!</p>
    </div>
</section>
